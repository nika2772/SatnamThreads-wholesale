...
CREATE TABLE IF NOT EXISTS orders (
  ...
  subtotal REAL DEFAULT 0, discount REAL DEFAULT 0, shipping REAL DEFAULT 0,
  tax REAL DEFAULT 0, total REAL DEFAULT 0,
  coupon TEXT DEFAULT '',
  name TEXT, email TEXT, phone TEXT, company TEXT DEFAULT '', gstin TEXT DEFAULT '',
  line1 TEXT, line2 TEXT DEFAULT '', city TEXT, state TEXT, pincode TEXT,
  notes TEXT DEFAULT '', tracking TEXT DEFAULT '', carrier TEXT DEFAULT '',
  created_at TEXT DEFAULT (datetime('now'))
);
...
CREATE TABLE IF NOT EXISTS order_items (
  ...
  unit_price REAL, qty INTEGER, line_total REAL
);
...
CREATE TABLE IF NOT EXISTS coupons (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  code TEXT UNIQUE, type TEXT DEFAULT 'percent', value REAL DEFAULT 0,
  min_order REAL DEFAULT 0, expires_at TEXT DEFAULT '', is_active INTEGER DEFAULT 1,
